...
public class WebRadar extends ListActivity  {
 ...
 //               setResult(Activity.RESULT_OK);
    ...
    ArrayList listTODO = (ArrayList) PrepareListFromXml();
    ...
    mainListView.setAdapter(new ArrayAdapter(WebRadar.this,
...
private void LoadSelections() {
    ...
    if (settingsActivity.contains(SETTING_WEBRADAR)) {
...
//    String savedFsize = getSavedFsize();
     ...
     prefEditor.putString(SETTING_WEBRADAR, savedItems);
